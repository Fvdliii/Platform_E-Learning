<x-app>
    ...
    <div class="card shadow-lg p-3">
        ...
        <div class="mb-3">
            <a class="btn btn-primary" href="{{ route('course.create') }}" role="button">Tambah</a>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-info btn-sm btn-detail"
                                    data-route="{{ route('course.show', $course) }}">
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Detail Kursus</h1>
